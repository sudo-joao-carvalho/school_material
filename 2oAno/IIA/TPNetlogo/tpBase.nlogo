...
to setup-patches
  ...
  ;set perc_AliV 0.15
  ;set perc_AliA 0.5
  set n_AliV num_patches * 0.15
  set n_AliA num_patches * 0.5
  set n_Armadilhas num_patches * 0.2
...
to setup-turtles
  ...
  [
    set color cyan
    let x one-of patches with[pcolor != green and pcolor != yellow and pcolor != red and pcolor != blue and not any? Basics-here and not any? Experts-here]
                  ...
                  [
                    ...
                    [
                      ...
                      [
                        ...
                        [
                          ifelse any? experts-on patch-ahead 1
                          [
                            set Energia Energia - (Energia * 0.10)
                            rt 90
                            fd 1
...
@#$#@#$#@
<experiments>
  <experiment name="MB_H1_10_10" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="MB_H1_15_15" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count Basics</metric>
    <metric>count Experts</metric>
  ...
  <experiment name="MB_H1_20_20" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count Basics</metric>
    <metric>count Experts</metric>
  ...
  <experiment name="MB_H2_10_101520" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count Basics</metric>
    <metric>count Experts</metric>
  ...
  <experiment name="MB_H2_15_101520" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count Basics</metric>
    <metric>count Experts</metric>
  ...
  <experiment name="MB_H2_20_101520" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count Basics</metric>
    <metric>count Experts</metric>
  ...
  <experiment name="MB_H3_10_10" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count Basics</metric>
    <metric>count Experts</metric>
  ...
  <experiment name="MB_H3_20_20" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count Basics</metric>
    <metric>count Experts</metric>
  ...
  <experiment name="MB_H3_15_15" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count Basics</metric>
    <metric>count Experts</metric>
