...
using PWeb2324_F1.Data;
using PWeb2324_F1.Models;

namespace PWeb2324_F1.Controllers
{
    public class AlunoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] Aluno aluno)
        {
            if (id != aluno.Id)
            {
                return NotFound();
