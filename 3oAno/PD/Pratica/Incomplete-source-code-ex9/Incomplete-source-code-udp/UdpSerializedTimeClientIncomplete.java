...
public class UdpSerializedTimeClientIncomplete {
    ...
    public static void main(String[] args) 
    {
        ...
        try(DatagramSocket socket = new DatagramSocket()){
            ...
            //bout = new ByteArrayOutputStream(); //cria o byteArray
            //oout = new ObjectOutputStream(bout); //manda esse array para uma ouputStream
            //oout.writeObject(TIME_REQUEST); // escreve o objeto para o outputStream
            //oout.flush();

            //Construir um datagrama UDP com o resultado da serializa��o
            /*packet = new DatagramPacket(bout.toByteArray(), bout.size(), serverA
                    serverPort);
