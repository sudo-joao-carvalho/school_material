...
public class BackupServer extends UnicastRemoteObject implements BackupServerRemoteInterface {
    ...
    private static final String ID_FILE_PATH = "resources/files/backup_server_id.txt"; // ficheiro de texto serve apenas para guardar e puxar os ids dos sv backup
